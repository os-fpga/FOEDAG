...
if (NOT MSVC AND NOT MINGW)
  if (NOT SEARCH_STATIC_LIB_RECURSE)
    message(STATUS "CSCHAI STATIC_LIB SEARCHING START:")
    execute_process(COMMAND find / -name "libpython*.a")
    message(STATUS "CSCHAI STATIC_LIB SEARCHING END:")
    set(SEARCH_STATIC_LIB_RECURSE ON CACHE BOOL "" FORCE)
  endif()
endif()
if ((MINGW OR (NOT MSVC AND WIN32)) AND EXISTS ${PYTHON3_FIND_PATH})
  ...
  if (TRUE)
    if (Python3_FOUND)
      ...
      get_filename_component(lib_path ${Python3_LIBRARIES} DIRECTORY)
      get_filename_component(exe_path ${Python3_EXECUTABLE} DIRECTORY)
      file(GLOB libs "${lib_path}/*python*")
      message(STATUS "CSCHAI PYTHON3: Lib Dir: ${lib_path}")
      message(STATUS "CSCHAI PYTHON3: Libs: ${libs}")
      ...
      set(os_py ${Python3_LIBRARY_DIRS}/os.py)
      if (EXISTS ${os_py})
        message(STATUS "CSCHAI PYTHON3: Found ${os_py}")
      else()
        set(os_py ${exe_path}/Lib/os.py)
        if (EXISTS ${os_py})
          message(STATUS "CSCHAI PYTHON3: Found ${os_py}")
        else()
          set(os_py ${Python3_LIBRARY_DIRS}/python${Python3_VERSION_MAJOR}.${Python3_VERSION_MINOR}/os.py)
          if (EXISTS ${os_py})
            message(STATUS "CSCHAI PYTHON3: Found ${os_py}")
          else()
