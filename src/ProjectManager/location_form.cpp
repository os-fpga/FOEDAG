    ...
    ui(new Ui::locationForm)
{
    ...
    ui->m_labelCont->setText(tr("This wizard will guide you through the creation of a new project."));
    ui->m_labelTail->setText(tr("To create a project you will need to provide a name and a location for your project files. "
                                "Next,you will specify the type of flow you'll be working with. "
                                "Finally,you will specify your project sources and choose a default part."));
...
QString locationForm::getprojectname()
{
    return ui->m_lineEditPname->text();
}
QString locationForm::getprojectpath()
{
    return ui->m_labelPath1->text();
}
...
{
    QString pathName = QFileDialog::getExistingDirectory(this, tr("Select Directory"),ui->m_lineEditPpath->text()==""?QDir::homePath():ui->m_lineEditPpath->text(),
