...
void NCriticalPathModelLoader::createItems(const std::vector<GroupPtr>& groups)
{
...
void NCriticalPathModelLoader::createItems(const std::vector<GroupPtr>& groups, const std::map<int, std::pair<int, int>>& metadata)
{
    // m_inputNodes.clear();
    // m_outputNodes.clear();
...
std::tuple<QString, QString, QString> NCriticalPathModelLoader::extractRow(QString l) const
{
    l = l.simplified();
