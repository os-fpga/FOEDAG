...
TclCommandIntegration::TclCommandIntegration(ProjectManager *projManager,
  ...
  connect(this, &TclCommandIntegration::createNewDesign, this,
          &TclCommandIntegration::createNewDesignSlot);
}
...
bool TclCommandIntegration::TclCreateProject(int argc, const char *argv[],
  ...
  // emit signal since call from another tcl thread
  emit createNewDesign(projName);
  return true;
}
...
void TclCommandIntegration::createNewDesignSlot(const QString &projName) {
