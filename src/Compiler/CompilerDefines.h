...
static constexpr uint PACKAGE{5};
static constexpr uint PLACEMENT{6};
static constexpr uint PLACEMENT_SETTINGS{7};
static constexpr uint PLACEMENT_WRITE_NETLIST{8};
static constexpr uint PLACEMENT_TIMING_REPORT{9};
static constexpr uint ROUTING{10};
static constexpr uint ROUTING_SETTINGS{11};
static constexpr uint ROUTING_WRITE_NETLIST{12};
static constexpr uint TIMING_SIGN_OFF{13};
static constexpr uint POWER{14};
static constexpr uint BITSTREAM{15};
