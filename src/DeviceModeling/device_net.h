...
public:
     ...
     */
    device_net(const std::string &net_name, std::shared_ptr<device_signal> signal_p = nullptr)
     ...
     */
    const std::set<std::shared_ptr<device_net>> &get_sink_set() const { return sink_set_; }
