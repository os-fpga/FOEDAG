...
TclWorker::TclWorker(TclInterp *interpreter, std::ostream &out,
  ...
  if (batchMode) {
    auto type = Tcl_GetChannelType(Tcl_GetStdChannel(TCL_STDIN));
    channelIn = new Tcl_ChannelType{
        ...
        type->outputProc,
        type->seekProc /*ChannelSeek*/,
        type->setOptionProc,
        type->getOptionProc,
        type->watchProc,
        type->getHandleProc, /*ChannelGetHandle,*/
        type->close2Proc /*ChannelClose2*/,
        type->blockModeProc, /*ChannelBlockMode,*/
        type->flushProc /*ChannelFlush*/,
        type->handlerProc /*ChannelHandler*/,
        type->wideSeekProc /*ChannelWideSeek*/,
        type->threadActionProc /*DriverThreadAction*/,
        type->truncateProc /*DriverTruncate*/,
    };
  }
