# These commands are in the FOEDAG folder in the file gbox_top.tcl

# puts  [ test_device_modeling_tcl ]
# puts [ exec date ]

# use "verbose" with the following sdt generation tcl command to display debugging information for the sdt generating cpp library "sdtgen_cpp_nlohman_lib_v6"
