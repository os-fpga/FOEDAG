...
int get_memory_node(json data, SdtMemoryNode &sdt_memory_node_obj, int verbose=0);

// void get_cpus_cluster(json data, SdtCpusClusterNode &sdt_cpus_cluster_node_obj) {
int get_cpus_cluster_node(json data, SdtCpusClusterNode &sdt_cpus_cluster_node_obj, int verbose=0);


// void get_rootmetadata_node (json data, SdtRootMetaDataNode &sdt_rootmetadata_node_obj) {
int get_rootmetadata_node (json data, SdtRootMetaDataNode &sdt_rootmetadata_node_obj, int verbose=0);
