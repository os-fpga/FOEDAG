...
TEST_F(DevicePortTest, SetGetBlock) {
    device_block* block = (device_block*)10101;  // Assuming device_block has a default constructor.
    device_port port;
...
TEST_F(DevicePortTest, StreamInsertionOperator) {
    ...
    std::string expected = "Port Name: test_port, Direction: Input, Signal: test_signal, Enclosing Block: nullptr";
