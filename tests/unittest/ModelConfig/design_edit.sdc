...
# set_io $auto_536                      HP_1_CC_18_9P  -mode MODE_BP_DIR_A_RX -internal_pin TO_BE_DETERMINED
...
set_io   $auto_535                      HR_2_4_2P      -mode MODE_BP_SDR_A_TX -internal_pin f2g_tx_clk_en_A 
...
set_io   $auto_529                      HP_2_20_10P    -mode MODE_BP_DIR_A_TX -internal_pin f2g_trx_dly_adj
...
# Signal: in:rule=half-first:f2g_trx_dly_inc
# Remap location from HP_2_20_10P to HP_2_20_10P
set_io   $auto_530                      HP_2_20_10P    -mode MODE_BP_DIR_A_TX -internal_pin f2g_trx_dly_inc
...
# Signal: in:rule=half-first:f2g_trx_dly_ld
# Remap location from HP_2_20_10P to HP_2_20_10P
set_io   $auto_531                      HP_2_20_10P    -mode MODE_BP_DIR_A_TX -internal_pin f2g_trx_dly_ld
...
set_io   $auto_532                      HR_2_2_1P      -mode MODE_RATE_8_A_TX -internal_pin f2g_tx_dvalid_A
...
# Signal: in:TO_BE_DETERMINED
# Skip reason: TO_BE_DETERMINED
# set_io $auto_533                      HR_2_2_1P      -mode MODE_RATE_8_A_TX -internal_pin TO_BE_DETERMINED
...
# Port: RST
# Signal: in:f2g_trx_reset_n_{A|B}
set_io   $auto_534                      HR_2_2_1P      -mode MODE_RATE_8_A_TX -internal_pin f2g_trx_reset_n_A
...
# Signal: in:TO_BE_DETERMINED
# Skip reason: TO_BE_DETERMINED
# set_io $f2g_trx_reset_n_$ibuf_reset_4 HP_1_4_2P      -mode MODE_BP_DDR_A_RX -internal_pin TO_BE_DETERMINED
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_527                      HP_1_8_4P      -mode MODE_BP_DDR_A_TX -internal_pin f2g_tx_oe_A
...
# Signal: in:TO_BE_DETERMINED
# Skip reason: TO_BE_DETERMINED
# set_io $f2g_trx_reset_n_$ibuf_reset   HP_1_8_4P      -mode MODE_BP_DDR_A_TX -internal_pin TO_BE_DETERMINED
...
# Port: T
# Signal: in:f2g_tx_oe_{A|B}
set_io   $auto_528                      HP_2_22_11P    -mode MODE_BP_DDR_A_TX -internal_pin f2g_tx_oe_A
...
# Signal: in:TO_BE_DETERMINED
# Skip reason: TO_BE_DETERMINED
# set_io $f2g_trx_reset_n_$ibuf_reset_2 HP_2_22_11P    -mode MODE_BP_DDR_A_TX -internal_pin TO_BE_DETERMINED
